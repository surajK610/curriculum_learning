...
python3 $EXPERIMENT_SRC_DIR/toy_model.py --hidden_num_layers 6 --vocab_size $curr_vocab --a $curr_a --prop_amb $curr_amb --forget_steps 1000 --sample_func "zipfian" --hidden_size 64 --intermediate_size 128 --output_dir "outputs/toy_model/zipfw-f_1000-amb_$curr_amb-vs_$curr_vocab-a_$curr_a" --weight_decay 0.01 ----extra_eval