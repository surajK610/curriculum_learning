#!/bin/bash
#SBATCH --job-name=toy_model_zipfbm
#SBATCH --output=outputs/toy_model/slurm_out/logzb_%a.out
#SBATCH --error=outputs/toy_model/slurm_out/logzb_%a.err
...
python3 $EXPERIMENT_SRC_DIR/toy_model.py --hidden_num_layers $curr_layer --vocab_size $curr_vocab --a $curr_a --sample_func "zipfian" --hidden_size 64 --intermediate_size 128 --output_dir "outputs/toy_model/zipfbm-layer_$curr_layer-vs_$curr_vocab-a_$curr_a"
